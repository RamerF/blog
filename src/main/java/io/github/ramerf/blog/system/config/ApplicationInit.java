...
import io.github.ramerf.blog.system.entity.Constant.PrivilegeEnum.PrivilegeEnumEntity;
...
public class ApplicationInit implements ApplicationRunner {
  ...
  private void initSuperAdmin(final List<Menu> menus) {
    ...
    superAdmin.setIsDelete(Boolean.FALSE);
  ...
  private void initVisitorAdmin(final List<Menu> menus) {
    ...
    visitor.setIsDelete(Boolean.FALSE);

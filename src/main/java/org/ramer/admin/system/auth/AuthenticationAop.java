package org.ramer.admin.system.auth;
...
import org.ramer.admin.system.util.RMIUtil;
...
public class AuthenticationAop {
  ...
  @Around("execution(@org.ramer.admin.system.auth.annotation.RequiredAuthentication * *(..))")
